export function RenderContent(){
  ...
  const homeDetails = {
    greetTxt: `Hello Good to see you, I'm`,
    name: 'RATCHATA ONTA',
    profilePhoto: 'profile.jpg',
    welcomeTxt: 'Welcome to my  website.',
    fbLink: 'https://www.facebook.com/ratchata.onta',
    tiktokLink: 'https://www.tiktok.com/@ratchata_21_',
    instagramLink: 'https://www.instagram.com/ratchata_21_/',
  ...
  const homeSection = document.querySelector('#home-section').innerHTML = homeHTML;
   ...
   const aboutDetails = {
    myPhoto: 'PR2.jpg',
    aboutMeFirstPrgrph: `Hi! I'm RATCHATA, I can a programlittle and I Like to play games efootball and Player football "
    `, }
